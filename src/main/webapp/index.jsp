...
<!-- Start Top Nav -->
 ...
 <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/semiProject/resources/assets/css/custom.css">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/semiProject/shopList/shop.do">용기매장리스트</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="/semiProject/resources/assets/img/gurut5.jpg" style= "float:right; width:522px; height:350px; vertical-align: middle;" alt="사진1">
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="/semiProject/resources/assets/img/gurut2.png" style= "float:right; width:522px; height:350px; vertical-align: middle;" alt="사진2">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="/semiProject/resources/assets/img/gurut3.png" style= "float:right; width:522px; height:350px; vertical-align: middle;" alt="사진2">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-6 p-5 mt-3" style= "text-align: center;">
                <a href="#"><img src="/semiProject/resources/assets/img/gurut6.png"  class="rounded-circle img-fluid border" style= "width:454px; height:385px; vertical-align: middle;" alt="사진1"></a>
            ...
            <div class="col-12 col-md-5 p-5 mt-3">
                <a href="#"><img src="/semiProject/resources/assets/img/gurut7.jpg"  class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <!-- <img src="shop-single.html"> -->
                            <img src="/semiProject/resources/assets/img/kk1.png" style= "height:410px;" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="/semiProject/resources/assets/img/kk2.png" style= "height:410px;" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="/semiProject/resources/assets/img/kk3.png" style= "height:410px;" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
...
<script src="/semiProject/resources/assets/js/jquery-1.11.0.min.js"></script>
    <script src="/semiProject/resources/assets/js/jquery-migrate-1.2.1.min.js"></script>
    <script src="/semiProject/resources/assets/js/bootstrap.bundle.min.js"></script>
    <script src="/semiProject/resources/assets/js/templatemo.js"></script>
    <script src="/semiProject/resources/assets/js/custom.js"></script>
</body>
</html>