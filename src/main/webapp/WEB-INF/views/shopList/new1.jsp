...
<style>
body {
background-image:url('/7team_project/resources/assets/img/be12.jpg');
}
</style>
<meta charset="UTF-8">
<title>매장 정보</title>
...
<body>
				...
				<div class='main3'>
					...
					<tr class='main2'><h1 class='text-success' text align='center'><strong><br/>매장명 : ${getAddInfo.shopName} </strong></h1></tr><br/>
