...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <!--!!!!! form !!!!!!-->
                                            <form class="needs-validation" method="post" action="manager_shopGoodsSizeInsert.do">
	...
	<script type="text/javascript"
		src="/7team_project/resources/js/manager/manager_goodsInShopAddSize.js"></script>
