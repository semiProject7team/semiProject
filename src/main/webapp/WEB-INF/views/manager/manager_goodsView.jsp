							...
							<div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
								...
								<!-- 매장정보페이지들어갈때 -->
									<c:when test="${param.shopNo != null }">
										...
										<a href="manager_goodsInShopAddSize.do?shopNo=${param.shopNo}&goodsNo=${param.goodsNo}"
										 class="btn btn-outline-light float-left">사이즈추가</a>
										<a href="manager_goodsInShopDeleteSize.do?shopNo=${param.shopNo}&goodsNo=${param.goodsNo}" 
