...
<body>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="mb-0">추가할 지역 입력하세요</h4>
                                        </div>
                                        <div class="card-body">
                                        
                                        <!--!!!!! form !!!!!!-->
                                            <form class="needs-validation" method="post"  enctype="multipart/form-data" action="manager_location_insert_result.do">
                                                <div class="mb-3">
                                                 	 <label >도시</label>
                                                     <input type="text" class="form-control" name="locName" id="locName" required>
                                                      <label id="locNameCheck" style="color:red;"></label>
                                                </div>
                                                
                                                
                                                <hr class="mb-4">
                                                <button class="btn btn-primary btn-lg btn-block" id="locationInsert" type="submit">지역등록</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
	...
	<script type="text/javascript"
		src="/7team_project/resources/js/manager/manager_location_insert.js"></script>
