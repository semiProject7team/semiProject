...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <!--!!!!! form !!!!!!-->
                                            <form class="needs-validation" method="post" action="manager_shop_insert_result.do">
                                                <div class="mb-3">
                                                 	 <label for="firstName">매장이름</label>
                                                     <input type="text" class="form-control" name="shopName" required>
                                                     
                                                </div>
                                                <div class="mb-3">
                                                 	 <label for="firstName">매장전화번호</label>
                                                     <input type="text" class="form-control" name="shopTel" required>
                                                     
                                                </div>
                                                <div class="mb-3">
                                                 	 <label for="firstName">매장상세주소</label>
                                                     <input type="text" class="form-control" name="shopAddr" required>
                                                     
                                                </div>
                                                <div class="mb-3">
                                                 	 <label for="firstName">지역고유번호</label>
                                                     <input type="text" class="form-control" name="locSn" id="locSn" required>
                                                     <label id="locSnCheck" style="color:red;"></label>
                                                </div>
                                                
                                                <hr class="mb-4">
                                                <button class="btn btn-primary btn-lg btn-block" id="insertShop" type="submit">매장추가</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
	...
	<script type="text/javascript"
		src="/7team_project/resources/js/manager/manager_shop_insert.js"></script>
