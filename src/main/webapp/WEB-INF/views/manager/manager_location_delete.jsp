...
<body>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="mb-0">지역삭제</h4>
                                        </div>
                                        <div class="card-body">
                                        
                                        <!--!!!!! form !!!!!!-->
                                            <form class="needs-validation" method="post" action="manager_locationDelete.do">
                                            	
                                                <div class="mb-3">
                                                 	 <label >삭제할 지역</label>
                                                     <select class="form-control" id="locSelectOption" name="locName">
                                                     	<c:forEach var="vo" items="${getLocNameList}" >
                                                     		<option>${vo.locName}</option>
                                                     	</c:forEach>
                                                     </select>
                                                </div>
                                                
                                                <hr class="mb-4">
                                                <button class="btn btn-primary btn-lg btn-block" id="deleteLocation" type="submit">지역삭제</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
	...
	<script type="text/javascript"
		src="/7team_project/resources/js/manager/manager_location_delete.js"></script>
